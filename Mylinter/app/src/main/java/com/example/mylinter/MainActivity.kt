...
class MainActivity : AppCompatActivity() {
    ...
    private var flashMode = 0 // Controla los modos de parpadeo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageButtonPower: ImageButton = findViewById(R.id.encendido)
        val imageButtonOff: ImageButton = findViewById(R.id.apagado)
        val imageButtonRayo: ImageButton = findViewById(R.id.flash)
        val textViewCounter: TextView = findViewById(R.id.textViewCounter)

        // Evento del botón de encendido de la linterna
